...
# keys = ['brownie','changetalk','sustain','neutral','avg / total']
keys = ['change_talk','sustain_talk','follow_neutral', 'macro / total', 'micro / total', 'weighted_mac / total']
#keys = ['change_talk','sustain_talk','follow_neutral', 'macro / total', 'micro / total', 'weighted_macro / total']
for key in keys:
    best_recall[key] = -1.0
