...
keys = ['change_talk','sustain_talk','follow_neutral', 'facilitate','giving_info', 'reflection_simple','reflection_complex', 'question_closed','question_open', 'MI_adherent','MI_non-adherent', 'macro / total', 'micro / total', 'weighted_mac / total']
for key in keys:
    best_recall[key] = -1.0
