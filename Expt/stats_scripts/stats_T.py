...
#keys = ['brownie', 'reflection_complex','reflection_simple','affirm','facilitate','givinginfo','question_open','question_closed','advise_wp','advise_wop', 'confront', 'structure', 'other', 'avg / total', 'weighted_macro']
keys = ['facilitate','giving_info', 'reflection_simple','reflection_complex', 'question_closed','question_open', 'MI_adherent','MI_non-adherent', 'macro / total', 'micro / total', 'weighted_mac / total']
#keys = ['facilitate','giving_info', 'reflection_simple','reflection_complex', 'question_closed','question_open', 'MI_adherent','MI_non-adherent', 'macro / total', 'micro / total', 'weighted_macro / total']
for key in keys:
    best_recall[key] = -1.0
