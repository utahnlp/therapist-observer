...
CONFIG_DIR=/categorizing/un_sn/bigru_d0.3_g1_semb8_twitter100
...
VOCAB_DIR=$DATA_DIR/vocab_twitter100_pred_un_sn/
...
WORD_EMB_FILE=$RO_DATA_DIR/glove.twitter.27B.100d.txt
# WORD_EMB_FILE=
