...
CONFIG_DIR=/categorizing/un_sn/bigru_t_xiao_g200
...
# VOCAB_DIR=$DATA_DIR/vocab_elmo_pre256_u0n_s0n_u_8/
VOCAB_DIR=$DATA_DIR/vocab_t_g200_pred_un_sn/
...
#WORD_EMB_FILE=$RO_DATA_DIR/psyc_glove_100d.txt
WORD_EMB_FILE=$RO_DATA_DIR/glove.6B.200d.txt
# WORD_EMB_FILE=
...
FOCAL_LOSS_GAMA=0,0,0,0,0,0,0,0
