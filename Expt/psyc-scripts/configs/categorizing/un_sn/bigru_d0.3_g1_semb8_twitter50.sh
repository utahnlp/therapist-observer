...
CONFIG_DIR=/categorizing/un_sn/bigru_d0.3_g1_semb8_twitter50
...
VOCAB_DIR=$DATA_DIR/vocab_twitter50_pred_un_sn/
...
WORD_EMB_FILE=$RO_DATA_DIR/glove.twitter.27B.50d.txt
# WORD_EMB_FILE=
