...
CONFIG_DIR=/categorizing/u0n_s0n/hlstm_8_p_semb_ru_rpu_prur_concat
...
VOCAB_DIR=$DATA_DIR/vocab_g_u0n_s0n_u_8/
...
DECODE_INPUTS=p_final,ru_final,r_final
...
USE_CONCAT_P=
# decode_func to usk for multiclass decoding
DECODE_FUC=FC
# flat Context-ware response attention
FLAT_C_R_ATT=
# flat response-wark context attention
FLAT_R_C_ATT=
