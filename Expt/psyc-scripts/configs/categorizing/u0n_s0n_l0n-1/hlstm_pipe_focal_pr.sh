...
CONFIG_DIR=/categorizing/u0n_s0n_ln-1/hlstm_pipe_focal_pr/
...
#WEIGHT_DECAY=0.0001
WEIGHT_DECAY=0.0
# BATCH_SIZE as 1 for alternative model
BATCH_SIZE=1
CONTEXT_WINDOW=8
QUESTION_WINDOW=1
HIDDEN_SIZE=128
...
P_MODEL_CONFIG=$ROOT_DIR/Expt/psyc-scripts/configs/categorizing/u0n_s0n_l0n-1/hlstm_8_p_semb_ru_elmo_pre1024_focal_pr_add_hs512_f1_lemb_lseq.sh
#config file for T model
T_MODEL_CONFIG=$ROOT_DIR/Expt/psyc-scripts/configs/categorizing/u0n_s0n_l0n-1/hlstm_t_rpu_snt_rpu_elmo_pre1024_focal_lemb_lseq_f0.sh
