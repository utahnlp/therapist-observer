...
CONFIG_DIR=/categorizing/u0n_s0n_ln-1/hlstm_4_semb_lemb_rs_ru/
...
VOCAB_DIR=$DATA_DIR/vocab_g_u0n_s0n_lemb_u_4/

mkdir -p $VOCAB_DIR

# Use ../../utils/preprocess.py to compute score for each paragraph

#TRAIN_FILENAME1=${CLUSTER_STRATEGY}/train_sc20.json
TRAIN_FILENAME1=${CLUSTER_STRATEGY}/train.json
#DEV_FILENAME1=${CLUSTER_STRATEGY}/dev_sc10.json
DEV_FILENAME1=${CLUSTER_STRATEGY}/dev.json
TEST_FILENAME1=${CLUSTER_STRATEGY}/test.json
#TEST_FILENAME1=${CLUSTER_STRATEGY}/dev_sc20.json
...
DECODE_R_WITH_FLATTEN_PU_LABELS=x
