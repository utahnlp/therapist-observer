...
CONFIG_DIR=/categorizing/u0n_s0n_ln-1/hlstm_pipe/
...
P_MODEL_CONFIG=$ROOT_DIR/Expt/psyc-scripts/configs/categorizing/u0n_s0n_l0n-1/hlstm_p_rpu_snt_rpu_elmo_pre1024_focal_lemb_lseq.sh
#config file for T model
T_MODEL_CONFIG=$ROOT_DIR/Expt/psyc-scripts/configs/categorizing/u0n_s0n_l0n-1/hlstm_t_rpu_snt_rpu_elmo_pre1024_focal_lemb_lseq.sh
