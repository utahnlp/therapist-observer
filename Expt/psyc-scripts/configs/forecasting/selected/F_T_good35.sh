...
CONFIG_DIR=/forecasting/selected/F_T_good35/
...
#ELMO_WEIGHT_FILE=$DATA_DIR/advising_elmo/advising.256.weights.hdf5
...
#ELMO_OPTION_FILE=$DATA_DIR/advising_elmo/advising.256.options.json
...
USE_BATCH_NORM=
# word attention heads
WORD_ATT_HEAD=1
# word attention hops
WORD_ATT_HOPS=1
# id filter file path
ID_FILTER_FILE=$RO_DATA_DIR/download/global_miti/ngoodids.txt
