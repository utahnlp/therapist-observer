...
CONFIG_DIR=/forecasting/u0n-1_l0n-1_s0n/hlstm_qu_pu_snt_qu_pu_att_elmo_dom256/
...
VOCAB_DIR=$DATA_DIR/vocab_elmo_dom256_u0n_s0n_u_8/
...
ELMO_WEIGHT_FILE=$DATA_DIR/psyc_elmo/psyc.elmo_256_weights.hdf5
...
ELMO_OPTION_FILE=$DATA_DIR/psyc_elmo/psyc.elmo_256_options.json
